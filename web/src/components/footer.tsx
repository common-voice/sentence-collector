...
export default function Footer() {
  return (
    <footer>
      ...
      >
        <Localized id="sc-footer-discourse">Discourse</Localized>
      </a>
      <a
        target="_blank"
        rel="noopener noreferrer"
      ...
      >
        <Localized id="sc-footer-report-bugs">Report Bugs</Localized>
      </a>
      <a
        target="_blank"
        rel="noopener noreferrer"
      ...
      >
        <Localized id="sc-footer-report-copyright">Report copyright issues</Localized>
      </a>
      <a target="_blank" rel="noopener noreferrer" href="https://commonvoice.mozilla.org/privacy">
        <Localized id="sc-footer-privacy">Privacy</Localized>
      </a>
      <a target="_blank" rel="noopener noreferrer" href="https://commonvoice.mozilla.org/terms">
        <Localized id="sc-footer-terms">Terms</Localized>
      </a>
      <a
        target="_blank"
        rel="noopener noreferrer"
      ...
      >
        <Localized id="sc-footer-cookies">Cookies</Localized>
      </a>
    </footer>
  );
}
