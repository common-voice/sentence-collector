...
## REVIEW THIS / FIXME - web/store.tsx 
## Uncaught Error: useLocalization was used without wrapping it in a <LocalizationProvider />.
## sc-store-loading = Yükleniyor…

## REVIEW THIS / FIXME - web/l10n.tsx - Language strings not loaded yet !
## sc-l10n-loading = %Loading…

###
### HEADER/FOOTER MENUS & LOGIN/LOGOUT
###

## OK - MAIN MENU ITEMS - web/components/header.tsx

sc-header-home = Anasayfa
sc-header-how-to = Nasıl
sc-header-add = Ekle
sc-header-review = Kontrol Et
sc-header-rejected = Reddedilen Cümleler
sc-header-my = Cümlelerim
sc-header-statistics = İstatistikler
sc-header-profile = Profil

## OK - BOTTOM MENU ITEMS - web/components/footer.tsx
sc-footer-discourse = Discourse
sc-footer-report-bugs = Hata Bildir
sc-footer-report-copyright = Telif sorunu bildir
sc-footer-privacy = Gizlilik
sc-footer-terms = Koşullar
sc-footer-cookies = Çerezler

## OK - LOGIN / LOGOUT - web/components/login-button.tsx
sc-login-button = Giriş / Kayıt
...
## HOW-TO - web/components/how-to.tsx
...
## MY SENTENCES - web/components/my-sentences-list.tsx

sc-my-title = Cümlelerim
sc-my-description = %This page gives you an overview of all your submitted sentencens.
    You may also delete already submitted sentences if needed by marking the checkbox next to it
    and clicking on &quot;Remove sentences&quot; at the bottom.
...
## PROFILE - web/components/profile.tsx

sc-profile-title = Profil: { $username }

## REJECTED SENTENCES - web/components/rejected-sentences-list.tsx
...
## REVIEW - web/components/review.tsx
...
sc-review-title = Cümle Kontrolü
...
## STATISTICS - web/components/stats.tsx

sc-stats-title = İstatistikler
sc-stats-last-update = %Last Update:
sc-stats-never = %never
...
## ADD - web/components/submit-form.tsx
...
## web/components/add-language-section.tsx (used in Profile page)
...
sc-add-err-failed = %{$sentences} sentences failed
sc-add-err-submission = %Submission Error

## web/components/confirm-form.tsx

sc-confirm-are-you-sure = %Sentences not submitted, are you sure you want to leave?
sc-confirm-sentences-title =
    .message = %Confirm New Sentences
sc-confirm-sentences-found = %{ $countOfSentences } sentences found.
sc-confirm-rejected-by-you = %{ $countOfInvalidated } rejected by you
sc-confirm-great-job = %-- { $countOfReviewed } sentences are already reviewed. Great job!
sc-confirm-ready = %{ $readyCount } sentences ready for submission!
...
## web/components/language-info.tsx (used in Statistics page)

sc-lang-info-total = %{ $totalSentences } total sentences.
sc-lang-info-in-review = %{ $totalInReview } sentences in review.
sc-lang-info-left-for-you = %{ $unreviewedSentencesByYou } sentences left for you to review.
sc-lang-info-review-now = Review now!
sc-lang-info-add-more = %<addLink>Add more sentences now!</addLink>
sc-lang-info-validated = %{ $validatedSentences } validated sentences.
sc-lang-info-rejected = %{ $rejectedSentences } rejected sentences.
...
## web/components/personal-language-info.tsx (used in Profile menu item)
...
sc-personal-added-by-you = %added by you
sc-personal-not-added = %You have not added any languages yet.

## web/components/review-criteria.tsx (used in Review menu item)
...
## web/components/review-form.tsx (used in Review menu item)

sc-review-form-prompt =
    .message = %Reviewed sentences not submitted, are sure?
sc-review-form-usage-1 = %Swipe right to approve the sentence. Swipe left to reject it. Swipe up to skip it.
sc-review-form-usage-2 = Do not forget to submit your review!
...
## web/components/review-links.tsx

sc-review-link = %Review

## SETTINGS - web/components/settings.tsx (used in Profile menu item)
...
## SKIPPED - web/actions/languages.tsx (these are console errors)

## sc-act-lang-err-fetch-stats = %Failed to fetch stats
## sc-act-lang-err-fetch-lang = %Failed to fetch languages

###
### REDUCERS
###

## web/reducers/sentences.tsx
## REVIEW THIS / FIXME : Uncaught Error: useLocalization was used without wrapping it in a <LocalizationProvider />.
## sc-red-sentences-review = &{ $noOfSentences } sentences reviewed. Thank you!

## web/reducers/settings.tsx
## REVIEW THIS / FIXME : Uncaught Error: useLocalization was used without wrapping it in a <LocalizationProvider />.
## sc-red-settings-err = &Could not change settings. Please try again.
